...
int main()
{
    int n; // valid rectangle will have sides parallel to x and y axis
...
// consider only daigonal points
 ...
 cout<<"maximum area of rectangle: "<<max_area<<endl;
  cout<<"minimum area of rectangle: "<<min_area<<endl;
