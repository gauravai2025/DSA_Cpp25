...
cout<<"Enter the number of vertices, edges and query\n";
...
else{  // if multiple edge between two node then take minimum edge weight
...
int u,v;
cin>>u>>v;
cout<<"shortest distance between "<<u<<" and "<<v<<" is: ";
cout<<dist[u][v]<<endl;
}
