...
// double pi = 3.14159265358979323846;  fixed_float(pi)  // 3.141592653589793
...
ll combination(ll n, ll r, ll m, ll *fact, ll *invfact)
{
    ll val1 = fact[n];
    ll val2 = invfact[n - r];
    ll val3 = invfact[r];
...
factorial();
inversefactorial();
cout<<"The number of derangement of "<<n<<" is: ";
cout<<derangement(n);
}
